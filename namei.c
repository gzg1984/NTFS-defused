 ...
 */
extern int ntfs_create_vfs_inode(struct inode *dir, struct dentry *dent, umode_t mode, bool __unused );
extern int ntfs_mkdir(struct inode *dir, struct dentry *dent, umode_t mode);
